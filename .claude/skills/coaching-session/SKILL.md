...
| Workout composition  | Delegated — bike/run to `plan-workout`, gym to `strength-training`, which hand the build to the forked `compose-workout` / `compose-strength-session` skills (see Constraints)                     |
